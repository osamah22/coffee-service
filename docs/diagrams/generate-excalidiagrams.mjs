...
flow(
  ...
  [
    ...
    { id: "staff", label: "Barista / Admin", x: 40, y: 300, w: 140, h: 64, color: colors.yellow },
    ...
    { id: "auth", label: "SuperTokens\nsessions", x: 510, y: 40, w: 170, h: 70, color: colors.purple },
  ...
  [
    ...
    { from: "frontend", to: "order", label: "HTTP JSON + cookies" },
    { from: "order", to: "auth", label: "session API" },
    { from: "auth", to: "db", label: "metadata" },
...
flow(
  ...
  [
    ...
    { id: "st", label: "SuperTokens\n:3567", x: 500, y: 55, w: 170, h: 75, color: colors.purple },
  ...
  [
    ...
    { from: "browser", to: "api", label: "HTTP JSON + cookies" },
    { from: "api", to: "st", label: "auth recipe" },
    { from: "st", to: "db", label: "metadata" },
...
flow(
  ...
  [
    ...
    { id: "auth", label: "Auth routes\nrole middleware", x: 330, y: 40, w: 170, h: 80, color: colors.green },
...
sequence("auth-role-sequence", "Auth And Role Flow", [
  ...
  { from: "user", to: "ui", text: "Submit email/password" },
  { from: "ui", to: "api", text: "POST /auth/signup or signin" },
  { from: "api", to: "st", text: "Create or verify user" },
  { from: "api", to: "api", text: "Resolve configured role" },
  { from: "api", to: "ui", text: "Set cookies", return: true },
  { from: "ui", to: "api", text: "GET /auth/me" },
  { from: "api", to: "ui", text: "{email, role}", return: true },
]);
...
flow(
  ...
  [
    ...
    { id: "session", label: "Valid\nsession?", x: 260, y: 215, w: 130, h: 110, kind: "decision", color: colors.yellow },
    { id: "guest", label: "Role: guest", x: 500, y: 340, w: 140, h: 70, color: colors.gray },
    { id: "email", label: "Read email\nclaim", x: 500, y: 170, w: 140, h: 80, color: colors.green },
    { id: "adminq", label: "In admin\nlist?", x: 700, y: 145, w: 120, h: 100, kind: "decision", color: colors.yellow },
    { id: "admin", label: "Role: admin", x: 740, y: 25, w: 140, h: 70, color: colors.purple },
    { id: "barq", label: "In barista\nlist?", x: 700, y: 285, w: 120, h: 100, kind: "decision", color: colors.yellow },
    { id: "barista", label: "Role: barista", x: 740, y: 430, w: 140, h: 70, color: colors.orange },
  ...
  [
    { from: "req", to: "session" },
    { from: "session", to: "guest", label: "No" },
    { from: "session", to: "email", label: "Yes" },
    { from: "email", to: "adminq" },
    { from: "adminq", to: "admin", label: "Yes" },
    { from: "adminq", to: "barq", label: "No" },
    { from: "barq", to: "barista", label: "Yes" },
    { from: "barq", to: "user", label: "No" },
    { from: "guest", to: "guard" },
    { from: "admin", to: "guard" },
    { from: "barista", to: "guard" },
    { from: "user", to: "guard" },
  ],
);
...
flow(
  ...
  620,
  [
    { id: "guest", label: "guest", x: 50, y: 55, w: 120, h: 60, color: colors.gray },
    { id: "user", label: "user", x: 50, y: 195, w: 120, h: 60, color: colors.green },
    { id: "barista", label: "barista", x: 50, y: 340, w: 120, h: 60, color: colors.orange },
    ...
    { id: "products", label: "Product\nCRUD", x: 720, y: 460, w: 150, h: 70, color: colors.red },
    { id: "delete", label: "Delete\norders", x: 900, y: 460, w: 120, h: 70, color: colors.red },
  ],
  [
...
flow(
  ...
  [
    ...
    { id: "auth", label: "Login /\nsignup panel", x: 230, y: 335, w: 150, h: 70, color: colors.purple },
    { id: "me", label: "Fetch\n/auth/me", x: 430, y: 335, w: 130, h: 70, color: colors.purple },
  ...
  [
    ...
    { from: "auth", to: "me" },
    { from: "me", to: "role" },
    { from: "role", to: "menu", label: "guest/user/admin" },
...
sequence("checkout-sequence", "Checkout Sequence", [
  ...
  { from: "handler", to: "handler", text: "Use session email" },
